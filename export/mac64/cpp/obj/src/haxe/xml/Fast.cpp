...
::String Fast_obj::get_name( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_name",0x9611daa7,"haxe.xml.Fast.get_name","/usr/lib/haxe/std/haxe/xml/Fast.hx",134,0xd31baf82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
::String Fast_obj::get_innerData( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_innerData",0x21ea0104,"haxe.xml.Fast.get_innerData","/usr/lib/haxe/std/haxe/xml/Fast.hx",137,0xd31baf82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(138)
	...
	if (((n != null()))){
		struct _Function_2_1{
			inline static bool Block( ::Xml &v){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/xml/Fast.hx",145,0xd31baf82)
				{
					HX_STACK_LINE(145)
		...
		if (((  (((bool((v->nodeType == ::Xml_obj::PCData)) && bool((n->nodeType == ::Xml_obj::CData))))) ? bool(_Function_2_1::Block(v)) : bool(false) ))){
			...
			struct _Function_3_1{
				inline static bool Block( Dynamic &it,::Xml &n2){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/xml/Fast.hx",147,0xd31baf82)
					{
...
Dynamic Fast_obj::get_elements( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_elements",0x6707fc93,"haxe.xml.Fast.get_elements","/usr/lib/haxe/std/haxe/xml/Fast.hx",164,0xd31baf82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(165)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &it){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/xml/Fast.hx",166,0xd31baf82)
			{
				...
				::haxe::xml::Fast run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","/usr/lib/haxe/std/haxe/xml/Fast.hx",168,0xd31baf82)
					{
						HX_STACK_LINE(169)
