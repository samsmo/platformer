...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/grizzle.png", __ASSET__assets_images_grizzle_png);
		type.set ("assets/images/grizzle.png", AssetType.IMAGE);
...
@:keep @:bind class __ASSET__assets_data_data_goes_here_txt extends flash.utils.ByteArray { }
@:keep @:bind class __ASSET__assets_data_room_001_oel extends flash.utils.ByteArray { }
@:keep @:bind class __ASSET__assets_images_grizzle_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
...
@:keep @:bind class __ASSET__assets_music_music_goes_here_txt extends flash.utils.ByteArray { }
@:keep @:bind class __ASSET__assets_sounds_sounds_go_here_txt extends flash.utils.ByteArray { }
@:keep @:bind class __ASSET__assets_sounds_beep_mp3 extends flash.media.Sound { }
@:keep @:bind class __ASSET__assets_sounds_flixel_mp3 extends flash.media.Sound { }
...
//@:bitmap("assets/images/grizzle.png") class __ASSET__assets_images_grizzle_png extends openfl.display.BitmapData {}
